...
// MODIFICATION 1: Include the SoftwareSerial library
...
// MODIFICATION 2: Define the SoftwareSerial port for the HC-10 module
// Arduino RX pin = 12 (connects to HC-10 TXD)
// Arduino TX pin = 13 (connects to HC-10 RXD)
...
void setup()
{
  ...
  // MODIFICATION 3: Configure Firmata to use the bluetooth serial port
  
  // Set the baud rate for the HC-10. 9600 is a common default.
  // Make sure this matches your module's configuration.
  bluetoothSerial.begin(9600);

  // Tell Firmata to use the bluetoothSerial object for communication.
  Firmata.begin(bluetoothSerial);

  // The original lines for hardware serial are no longer needed:
  // Firmata.begin(57600);
  // while (!Serial) {
